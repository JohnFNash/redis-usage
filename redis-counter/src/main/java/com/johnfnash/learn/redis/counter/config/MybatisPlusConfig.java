package com.johnfnash.learn.redis.counter.config;
...
@Configuration
@MapperScan("com.johnfnash.learn.redis.counter.**.mapper*")
public class MybatisPlusConfig {
     ...
     */
    @Bean
    public MybatisPlusInterceptor InnerInterceptor(@Value("${app-config.mybatisplus.maxPageSize:10000}") long maxPageSize) {
